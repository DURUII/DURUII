...
<!-- 序号: 23, 学号: 202013407457, 姓名: 杜睿, 专业名称: 软件工程, 班级名称: 软件工程2020级3班, 培养层次: 普通本科, 所修总门数: 63, 所修总学分: 151, 所得学分: 151, 未得学分: 0, 平均分: 88.49, 平均学分绩: 88.4, 平均学分绩点: 3.67, 专业排名: 7/173, 年级排名: 23/540 -->
...
武汉金山办公软件有限公司Office产研事业部，**Go服务端开发实习生**
~ 2025.07 - 2025.08
- 负责OCR业务的后端日志分析与功能开发。期间独立排查并分析百万级Kibana错误日志，梳理上下游调用链并优化超时与重试机制；基于Go + Gin + Redis实现OCR去水印与表格识别等接口开发，完善单例模式Option配置与上下文超时控制，复现并解决context canceled、HTTP Client超时等典型问题；撰写自动化脚本对比腾讯云与PCV模型识别效果，参与旧服务代码迁移与架构优化（DDD/IoC）。
<!-- - 参与OCR业务的日志排查与问题定位，分析百万级Kibana错误日志并结合上下游调用链梳理问题来源，提升系统可观测性。
- 基于Go语言对服务端核心模块进行调试与优化，复现并解决context canceled、HTTP Client超时等典型问题。
- 参与OCR扫描、去水印及表格结构化识别等功能开发与测试，使用Redis、Gin框架及Option模式实现可配置化接口设计。
- 对比测试腾讯云与PCV AI模型在文档识别精度上的差异，编写自动化脚本与UI测试流程，形成性能评估报告。
- 参与运营活动后端需求开发与旧服务代码迁移，理解DDD/IoC架构思想，独立完成模块改造与联调上线。 -->
...
<!-- 第四届“外教社•词达人杯”全国大学生英语词汇能力大赛全国一等奖 -->
...
<!-- 具有良好的编程习惯，简洁清晰的代码风格，善于学习，具备独立分析和解决问题的能力； -->
<!-- 
4. 善于团队合作，有优秀的协同能力，会把给用户创造价值帮助用户当做一件非常有自豪感和成就感的事情
5，极强的目标感，条理性，做事情能够持续、坚持，脚踏实地。 -->

<!-- 有过互联网产品实习经历更佳。

对新事物具有探求精神，思维活跃，具备较强的团队协作意识。 -->

<!-- - 具有一定的逻辑沟通、文案设计与观点表达能力。
大一刚入学时，在新生杯辩论赛中我，与班上同学一起为班级争得冠军，获得最佳辩手，锻炼了自己的表达与思辨能力。 -->

<!-- - 具有一定的组织领导与团队协作能力。
视频剪辑。
大一下学期到大二上学期，我利用假期与周末空闲时间，在新东方中学部兼职助教，兼任组长负责两个校区的助教面试、排班与管理工作，期间锻炼了我的组织能力。目前，作为Java俱乐部的负责人，从通知面试到讲题培训，与其他同学一道，实现了从无到有的搭建过程。 -->

<!-- - 具有一定的学习钻研与资料检索能力。
加入我校英语试点班后，大一报名参加全国大学生英语竞赛只拿到了三等奖（全校排名246）。为了进一步精进自己的英语水平，不辜负老师的培养和期待，我课下精听了不少课程，研读了不少专著，与老师和同学讨论了不少语法现象；同时，为了理清做题逻辑，还试着自己讲一遍英语题上传到网络上；今年第二次参赛，拿到了全校唯二，全省第七的好成绩。
除了悉心钻研外语，专业方面，蓝桥杯在张智老师的指导下也拿到了国家二等奖。今年暑假，我报名了我校数学建模的培训，它让我对数学、编程产生了新的敬畏，新的斗志，对资料检索有了新的认识。 -->
